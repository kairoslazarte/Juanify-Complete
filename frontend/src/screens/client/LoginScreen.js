        ...
        <div className="login-screen_form-container">
          <div className="login-screen_form-container-styles">
            ...
            <div className="login-screen_margintop">
              ...
              {/* <div className="login-screen_grid">
                <div>
                  <a
                    href="#"
                    className="login-screen_a-icons"
                  >
                    <span className="login-screen_span">Sign in with Facebook</span>
                    <svg className="login-screen_w-h" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                      <path
                        fillRule="evenodd"
                ...
                <div>
                  <a
                    ...
                    className="login-screen_a-icons"
                  >
                    <span className="login-screen_span">Sign in with Twitter</span>
                    <svg className="login-screen_w-h" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div>
                  <a
                    ...
                    className="login-screen_a-icons"
                  >
                    <span className="login-screen_span">Sign in with GitHub</span>
                    <svg className="login-screen_w-h" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                      <path
                        fillRule="evenodd"
